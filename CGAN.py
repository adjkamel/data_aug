...
# -------------------------------------------------------- parameters
image_dir = './images_CGAN/' # image path contains original dataset or dattaset after augmentation, it must contain two folders /train and /test
